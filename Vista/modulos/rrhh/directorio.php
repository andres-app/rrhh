...
<main class="flex-1 flex flex-col h-screen overflow-hidden relative bg-slate-50">
    ...
    <header class="h-20 bg-white shadow-sm flex items-center px-8 justify-between z-10">
        ...
        <div class="flex items-center gap-4">
            <span class="text-sm text-slate-500 font-medium"><?php echo count($empleados); ?> Colaboradores</span>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-slate-600">
                            <div class="flex flex-col">
                                <span class="flex items-center mb-1">
                                    <svg class="w-3.5 h-3.5 mr-1.5 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
