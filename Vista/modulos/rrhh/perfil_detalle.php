    ...
    <div class="max-w-6xl mx-auto px-6">
        <div class="relative -mt-24">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="space-y-4 text-sm">
                                    ...
                                    <div class="flex justify-between border-b border-slate-50 pb-2">
                                        ...
                                        <span class="font-bold text-slate-700">
                                            <?php echo !empty($data['edad']) ? $data['edad'] . ' años' : '—'; ?>
                                        </span>
                                    </div>
                                    <div class="flex justify-between border-b border-slate-50 pb-2">
                                ...
                                <div class="space-y-4 text-sm">
                                    ...
                                    <div class="flex justify-between border-b border-slate-50 pb-2">
                                        ...
                                        <span class="font-bold text-slate-700"><?php echo htmlspecialchars($data['fecha_nacimiento'] ?? '—'); ?></span>
                                    </div>
                                    <div class="flex justify-between border-b border-slate-50 pb-2">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="space-y-2 text-sm">
                                    ...
                                    <div class="p-3 bg-slate-50 rounded-xl flex justify-between items-center border border-slate-100">
                                        ...
                                        <span class="font-bold text-slate-700 text-[11px]"><?php echo htmlspecialchars($data['correo_personal'] ?? '—'); ?></span>
                                    </div>
                                    <div class="p-3 bg-slate-50 rounded-xl flex justify-between items-center border border-slate-100">
                        ...
                        <div class="bg-white p-6 rounded-3xl shadow-sm border border-slate-200">
                            ...
                            <div class="p-4 bg-red-50 rounded-2xl mb-3 border border-red-100">
                                ...
                                <p class="text-[10px] text-red-400 mt-1">
                                    Nac: <?php echo htmlspecialchars($data['onomastico_conyuge']); ?>
                                </p>
                                <?php endif; ?>
                            </div>
                        ...
                        <div class="bg-white p-6 rounded-3xl shadow-sm border border-slate-200">
                            ...
                            <div class="space-y-4 text-sm">
                                ...
                                <div class="flex justify-between px-2">
                                    ...
                                    <span class="font-bold text-slate-700"><?php echo htmlspecialchars($data['fecha_ingreso'] ?? '—'); ?></span>
                                </div>
                                <div class="flex justify-between px-2">
                                ...
                                <?php if (!empty($data['fecha_cese'])): ?>
                                <div class="flex justify-between px-2">
                                    <span class="text-slate-400">Fecha Cese</span>
                                    <span class="font-bold text-red-600"><?php echo htmlspecialchars($data['fecha_cese']); ?></span>
                                </div>
                                <?php endif; ?>
                            </div>
                        </div>
            ...
            <!-- ============================================================
                 ...
                 CORRECCIÓN: Ahora usa descripcion_carrera e institucion
                 que vienen del LEFT JOIN con colab_formacion
            ============================================================ -->
            <div id="tab-formacion" class="tab-content hidden animate-fadeIn">
                <div class="bg-white p-8 rounded-3xl shadow-sm border border-slate-200">
                    ...
                    <?php if (!empty($data['descripcion_carrera']) || !empty($data['tipo_grado']) || !empty($data['institucion'])): ?>
                    <div class="space-y-6">
                        <div class="relative pl-8 border-l-2 border-red-100 space-y-8">
                            <div class="relative">
                                ...
                                <!-- Tipo de grado (antes "Grado Principal") -->
                                <p class="text-[10px] font-black text-red-800 uppercase tracking-widest mb-1">
                                    <?php echo htmlspecialchars($data['tipo_grado'] ?? 'Grado Principal'); ?>
                                </p>

                                <!-- Descripción / carrera (antes 'profesion' que NO existía) -->
                                <h4 class="text-lg font-bold text-slate-800 mb-1">
                                    <?php echo htmlspecialchars($data['descripcion_carrera'] ?? 'No registrado'); ?>
                                </h4>

                                <!-- Institución -->
                                <p class="text-slate-500 italic">
                                    <?php echo htmlspecialchars($data['institucion'] ?? 'Institución no registrada'); ?>
                                </p>
                            </div>
                        </div>
                    </div>
                    <?php else: ?>
                    <!-- Estado vacío cuando no hay formación registrada en BD -->
                    <div class="text-center py-16">
                        ...
                        <p class="text-slate-400 max-w-sm mx-auto text-sm">
                            Aún no se ha registrado información académica para este colaborador en el sistema.
                        </p>
                    </div>
                    <?php endif; ?>
                </div>
